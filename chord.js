var locations = [
    ...
    { id: 1, name: "Exitement", color: "#7cf2f7" },
    { id: 2, name: "Purpose", color: "#3e0a50" },
    { id: 3, name: "Hope", color: "#ffbb00" },
    { id: 4, name: "Success", color: "#019c60" },
    { id: 5, name: "Recognition", color: "#d8ae36" },
    { id: 6, name: "Fear", color: "#ff7222" },
    { id: 7, name: "Anticipaiton", color: "#37b0df" },
    { id: 8, name: "Gratitude", color: "#ffffff" },
    { id: 9, name: "Inspiration", color: "#bf77f6" },
    { id: 10, name: "Joy", color: "#ed88ad" },
    { id: 11, name: "Passion", color: "#006850" }
  ];
